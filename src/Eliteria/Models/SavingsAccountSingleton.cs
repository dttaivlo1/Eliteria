...
{
    public sealed class SavingsAccountSingleton
    {
        ...
        public static SavingsAccountSingleton Instance { get; } = new SavingsAccountSingleton();
       public ObservableCollection<SavingsAccount> accounts { get; } = new ObservableCollection<SavingsAccount>();

        private SavingsAccountSingleton() { }
        public async void init()
        {
            ObservableCollection<SavingsAccount> savingsAccounts = await LoadListFromDatabase();
        ...
        public static async Task<ObservableCollection<SavingsAccount>> updateFromDatabase()
        {
            ObservableCollection<SavingsAccount> savingsAccounts = new ObservableCollection<SavingsAccount>();

            return await LoadListFromDatabase();
        }
    }
}
